...
class NewVisitorTest(LiveServerTestCase):
    def setUp(self):
        self.opts = Options()
        # Snap path 
        self.opts.binary_location = "/snap/firefox/current/usr/lib/firefox/firefox"
        self.init_browser()
    ...
    def test_multiple_users_can_start_lists_at_different_urls(self):
        ...
        ## informação de Edith está vindo de cookies 
        self.browser.quit()
        self.init_browser()
        ...
        # Francis inicia uma nova linha inserindo um item novo.
